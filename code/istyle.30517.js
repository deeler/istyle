/*!
* istyle.js 30517
* transition,modal,dropdown,tab,tooltip,popover,prettify,alert,calendar,tablesorter,scrollspy,affix,button,collapse,carousel,typeahead,loading
* 2013-05-21 09:40
*/
/* ===================================================
  ...
  iCalendar.prototype = {
    ...
    _init: function(el, options){
      ...
      $.extend(true, this.options, options);
            ...
            el.bind(that.options.targetTrigger,function(){
                $('.icalendar').hide();
                if( !that._target ) {
